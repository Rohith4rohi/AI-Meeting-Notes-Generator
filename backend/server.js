...
// CORS
app.use(cors({
  origin: process.env.FRONTEND_URL || 'https://ai-meeting-notes-generator-frontend.onrender.com',
  credentials: true
}));
...
app.get('/api/health', (req, res) => {
  res.json({ status: 'ok', message: 'AI Meeting Notes API is running', timestamp: new Date().toISOString() });
});
